...
\end{aligned}
    ...
    <Step title="Bedingte Wahrscheinlichkeit berechnen">
      ...
      Mit der Definition der [bedingten Wahrscheinlichkeit](/bedingte-wahrscheinlichkeit/bedingte-wahrscheinlich)
...
\end{aligned}
    ...
    <Step title="Verhältnisse bilden und Aussgae beurteilen">
